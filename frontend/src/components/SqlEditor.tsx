...
import type { IcebergTableInfo, IcebergTableSchema, SqlQueryResult } from '../services/api';
...
export default function SqlEditor() {
  ...
  return (
    <div className="flex h-full gap-4">
      ...
      <div className="w-64 flex-shrink-0 bg-gray-900 border border-gray-800 rounded-xl p-3 overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col gap-4 min-w-0">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 flex flex-col">
          ...
          <textarea
            ...
            className="w-full h-36 bg-gray-950 border border-gray-800 rounded-lg p-3 text-sm text-gray-200 font-mono resize-y focus:outline-none focus:ring-1 focus:ring-blue-500 placeholder-gray-600"
            spellCheck={false}
          />
        </div>
